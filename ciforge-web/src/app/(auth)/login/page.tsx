...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("demo@ciforge.dev");
    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-bg">
      ...
      <div className="flex items-center justify-center p-8 lg:p-16 relative">
        ...
        >
          ...
          <p className="text-[var(--text2)] text-[15px] font-light mb-10">
            Sign in to your CIForge account
          </p>
          ...
          <form onSubmit={handleCredentials} className="flex flex-col gap-4">
            {error && (
              <div className="p-3 rounded-lg text-sm status-failed text-center">
                {error}
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-[10px] text-[15px] font-medium text-white transition-all mt-1 disabled:opacity-60 flex items-center justify-center gap-2"
              style={{
          ...
          >
            ...
            >
              <div style={{ color: "var(--purple2)" }}>
                ❯ <span style={{ color: "var(--text)" }}>ciforge generate github.com/user/api</span>
              </div>
              ...
              <div style={{ color: "var(--text3)" }}>  → .github/workflows/ci-cd.yml</div>
            </div>
          </div>
        </div>
      </div>
